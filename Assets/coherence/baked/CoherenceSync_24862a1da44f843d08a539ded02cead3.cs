...
namespace Coherence.Generated
{
    ...
    public class Binding_24862a1da44f843d08a539ded02cead3_4aecf294003947d48719584e47b52f4e : PositionBinding
    {   
    ...
    [UnityEngine.Scripting.Preserve]
    public class Binding_24862a1da44f843d08a539ded02cead3_91203e526e08431c84487345bcd960c9 : RotationBinding
    {   
        private global::UnityEngine.Transform CastedUnityComponent;
    ...
    [UnityEngine.Scripting.Preserve]
    public class CoherenceSync_24862a1da44f843d08a539ded02cead3 : CoherenceSyncBaked
    {
        private Entity entityId;
        private Logger logger = Coherence.Log.Log.GetLogger<CoherenceSync_24862a1da44f843d08a539ded02cead3>();
        ...
        {
			["4aecf294003947d48719584e47b52f4e"] = new Binding_24862a1da44f843d08a539ded02cead3_4aecf294003947d48719584e47b52f4e(),
			["91203e526e08431c84487345bcd960c9"] = new Binding_24862a1da44f843d08a539ded02cead3_91203e526e08431c84487345bcd960c9(),
        };
        
        private Dictionary<string, Action<CommandBinding, CommandsHandler>> bakedCommandBindings = new Dictionary<string, Action<CommandBinding, CommandsHandler>>();
        
        public CoherenceSync_24862a1da44f843d08a539ded02cead3()
        {
        }
            ...
            switch (command)
            {
                default:
                    logger.Warning(Coherence.Log.Warning.ToolkitBakedSyncReceiveCommandUnhandled,
                        $"CoherenceSync_24862a1da44f843d08a539ded02cead3 Unhandled command: {command.GetType()}.");
                    break;
            }
        }
        ...
        {
            this.logger = logger.With<CoherenceSync_24862a1da44f843d08a539ded02cead3>();
            this.bridge = bridge;

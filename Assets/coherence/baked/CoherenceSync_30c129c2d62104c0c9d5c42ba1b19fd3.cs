...
namespace Coherence.Generated
{
    ...
    public class Binding_30c129c2d62104c0c9d5c42ba1b19fd3_b69d14f87b534835bc064fdb9bc877a2 : PositionBinding
    {   
    ...
    [UnityEngine.Scripting.Preserve]
    public class CoherenceSync_30c129c2d62104c0c9d5c42ba1b19fd3 : CoherenceSyncBaked
    {
        private Entity entityId;
        private Logger logger = Coherence.Log.Log.GetLogger<CoherenceSync_30c129c2d62104c0c9d5c42ba1b19fd3>();
        ...
        {
			["b69d14f87b534835bc064fdb9bc877a2"] = new Binding_30c129c2d62104c0c9d5c42ba1b19fd3_b69d14f87b534835bc064fdb9bc877a2(),
        };
        
        private Dictionary<string, Action<CommandBinding, CommandsHandler>> bakedCommandBindings = new Dictionary<string, Action<CommandBinding, CommandsHandler>>();
        
        public CoherenceSync_30c129c2d62104c0c9d5c42ba1b19fd3()
        {
        }
            ...
            switch (command)
            {
                default:
                    logger.Warning(Coherence.Log.Warning.ToolkitBakedSyncReceiveCommandUnhandled,
                        $"CoherenceSync_30c129c2d62104c0c9d5c42ba1b19fd3 Unhandled command: {command.GetType()}.");
                    break;
            }
        }
        ...
        {
            this.logger = logger.With<CoherenceSync_30c129c2d62104c0c9d5c42ba1b19fd3>();
            this.bridge = bridge;

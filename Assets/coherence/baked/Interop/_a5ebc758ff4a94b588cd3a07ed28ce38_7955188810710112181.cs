...
namespace Coherence.Generated
{
    ...
    public struct _a5ebc758ff4a94b588cd3a07ed28ce38_7955188810710112181 : ICoherenceComponentData
    {
        ...
        {
            FieldsMask |= _a5ebc758ff4a94b588cd3a07ed28ce38_7955188810710112181.rotationMask;
            rotationSimulationFrame = frame;
        }

        public static unsafe _a5ebc758ff4a94b588cd3a07ed28ce38_7955188810710112181 FromInterop(IntPtr data, Int32 dataSize, InteropAbsoluteSimulationFrame* simFrames, Int32 simFramesCount)
        {
            if (dataSize != 16) {
            ...
            var orig = new _a5ebc758ff4a94b588cd3a07ed28ce38_7955188810710112181();
        ...
        public AbsoluteSimulationFrame? GetMinSimulationFrame()
        {
            ...
            if ((FieldsMask & _a5ebc758ff4a94b588cd3a07ed28ce38_7955188810710112181.rotationMask) != 0 && (min == null || this.rotationSimulationFrame < min))
            {
        ...
        {
            var other = (_a5ebc758ff4a94b588cd3a07ed28ce38_7955188810710112181)data;
        ...
        public static uint Serialize(_a5ebc758ff4a94b588cd3a07ed28ce38_7955188810710112181 data, bool isRefSimFrameValid, AbsoluteSimulationFrame referenceSimulationFrame, IOutProtocolBitStream bitStream, Logger logger)
        {
        ...
        public static _a5ebc758ff4a94b588cd3a07ed28ce38_7955188810710112181 Deserialize(AbsoluteSimulationFrame referenceSimulationFrame, InProtocolBitStream bitStream)
        {
            ...
            var val = new _a5ebc758ff4a94b588cd3a07ed28ce38_7955188810710112181();
            if (bitStream.ReadMask())
            {
                ...
                val.FieldsMask |= _a5ebc758ff4a94b588cd3a07ed28ce38_7955188810710112181.rotationMask;
            }
        ...
        {
            return $"_a5ebc758ff4a94b588cd3a07ed28ce38_7955188810710112181(" +

...
namespace Coherence.Generated
{
    ...
    public struct _a5ebc758ff4a94b588cd3a07ed28ce38_509211006191760177 : ICoherenceComponentData
    {
        ...
        {
            FieldsMask |= _a5ebc758ff4a94b588cd3a07ed28ce38_509211006191760177.rotationMask;
            rotationSimulationFrame = frame;
        }

        public static unsafe _a5ebc758ff4a94b588cd3a07ed28ce38_509211006191760177 FromInterop(IntPtr data, Int32 dataSize, InteropAbsoluteSimulationFrame* simFrames, Int32 simFramesCount)
        {
            if (dataSize != 16) {
            ...
            var orig = new _a5ebc758ff4a94b588cd3a07ed28ce38_509211006191760177();
        ...
        public AbsoluteSimulationFrame? GetMinSimulationFrame()
        {
            ...
            if ((FieldsMask & _a5ebc758ff4a94b588cd3a07ed28ce38_509211006191760177.rotationMask) != 0 && (min == null || this.rotationSimulationFrame < min))
            {
        ...
        {
            var other = (_a5ebc758ff4a94b588cd3a07ed28ce38_509211006191760177)data;
        ...
        public static uint Serialize(_a5ebc758ff4a94b588cd3a07ed28ce38_509211006191760177 data, bool isRefSimFrameValid, AbsoluteSimulationFrame referenceSimulationFrame, IOutProtocolBitStream bitStream, Logger logger)
        {
        ...
        public static _a5ebc758ff4a94b588cd3a07ed28ce38_509211006191760177 Deserialize(AbsoluteSimulationFrame referenceSimulationFrame, InProtocolBitStream bitStream)
        {
            ...
            var val = new _a5ebc758ff4a94b588cd3a07ed28ce38_509211006191760177();
            if (bitStream.ReadMask())
            {
                ...
                val.FieldsMask |= _a5ebc758ff4a94b588cd3a07ed28ce38_509211006191760177.rotationMask;
            }
        ...
        {
            return $"_a5ebc758ff4a94b588cd3a07ed28ce38_509211006191760177(" +
